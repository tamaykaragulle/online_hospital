  ...
  <div class="register-box">
      <form action="<?php $_PHP_SELF ?>" method="post" enctype="multipart/form">
        <div class="form-group">
          <input type="text" placeholder="Doctor Name" maxlength="20" name="patient_username" class="form-control <?php echo (!empty($patient_username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $patient_username; ?>">
          <span class="invalid-feedback"><?php echo $patient_username_err; ?></span>
        </div>
        <div class="form-group">
          <input type="password" placeholder="Doctor Password" maxlength="20" name="patient_password" class="form-control <?php echo (!empty($patient_password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $patient_password; ?>">
          <span class="invalid-feedback"><?php echo $patient_password_err; ?></span>
        </div>
        <div class="form-group">
          <input type="email" placeholder="Doctor E-Mail" maxlength="5" name="patient_mail" class="form-control <?php echo (!empty($patient_mail_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $patient_mail; ?>">
