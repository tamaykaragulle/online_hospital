...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
  ...
  else
  {
      ...
      $statement = $link->prepare("SELECT doctor_username FROM doctors WHERE doctor_speciality = ?");
    ...
    <form action="<?php $_PHP_SELF ?>" method="post" enctype="multipart/form">
      <select>
        ...
        <?php
            ...
            {
                $doctor_name = $row['doctor_username'];
                echo "<option value='strtolower($doctor_name)'>$doctor_name</option>";
            }
         ?>
      </select>
